...
class Skein1024_1024PlatformTest {
...
@IgnoreIos
class Skein1024_1024InstalledProviderTest : Skein1024_1024Test() {
    ...
    override fun digest(): Digest<*> = PlatformDigest().create(Algorithm.Skein1024_1024) ?: fail()
