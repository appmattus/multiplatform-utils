...
// No built-in support
class GOST3411_2012_512PlatformTest {
...
@IgnoreIos
class GOST3411_2012_51InstalledProviderTest : GOST3411_2012_512Test() {
    ...
    override fun digest(): Digest<*> = PlatformDigest().create(Algorithm.GOST3411_2012_512) ?: fail()
