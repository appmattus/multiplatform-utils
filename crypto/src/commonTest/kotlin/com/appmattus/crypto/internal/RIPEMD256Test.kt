...
@IgnoreIos
class RIPEMD256InstalledProviderTest : RIPEMD256Test() {
    ...
    override fun digest(): Digest<*> = PlatformDigest().create(Algorithm.RIPEMD256) ?: fail()
