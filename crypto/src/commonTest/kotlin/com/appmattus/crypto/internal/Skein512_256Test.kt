...
class Skein512_256CoreTest : Skein512_256Test() {
    override fun digest(): Digest<*> = CoreDigest.create(Algorithm.Skein512_256)
...
class Skein512_256PlatformTest {

    @Test
    fun noImplementation() {
        assertNull(PlatformDigest().create(Algorithm.Skein512_256))
    }
}

// No built-in iOS support
@IgnoreIos
class Skein512_256InstalledProviderTest : Skein512_256Test() {
    ...
    override fun digest(): Digest<*> = PlatformDigest().create(Algorithm.Skein512_256) ?: fail()
...
/**
 * Test Skein-512-256 implementation.
 */
abstract class Skein512_256Test {
    ...
    fun zero() {
        testKat(
            digest(),
            ByteArray(128),
            "2D0E2E241972DF39BE822A8C682105C6" +
                    "4747FAF8A10EC032881DE7DC67887CC2"
        )
    }
