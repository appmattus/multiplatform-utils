...
class Haraka512_256PlatformTest {
...
@IgnoreIos
class Haraka512_256InstalledProviderTest : Haraka512_256Test() {
    ...
    override fun digest(): Digest<*> = PlatformDigest().create(Algorithm.Haraka512_256) ?: fail()
