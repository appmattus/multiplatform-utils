...
class Skein1024_512PlatformTest {
...
@IgnoreIos
class Skein1024_512InstalledProviderTest : Skein1024_512Test() {
    ...
    override fun digest(): Digest<*> = PlatformDigest().create(Algorithm.Skein1024_512) ?: fail()
