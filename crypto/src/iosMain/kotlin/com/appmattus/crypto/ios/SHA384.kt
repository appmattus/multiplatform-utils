...
internal class SHA384 : Digest<SHA384> {
    ...
    override fun update(input: ByteArray, offset: Int, length: Int) {
        if (length > 0) {
            input.usePinned {
                CC_SHA384_Update(hashObjectPtr, it.addressOf(offset), length.toUInt())
            }
        }
    }
    ...
    override fun digest(): ByteArray {
        ...
        digest.usePinned {
            CC_SHA384_Final(it.addressOf(0), hashObjectPtr)
        }
