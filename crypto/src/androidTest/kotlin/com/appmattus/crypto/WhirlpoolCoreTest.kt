...
class WhirlpoolCoreTest {
    ...
    fun testWhirlpool() {
        ...
        testKat(
            dig, "a", "8ACA2602792AEC6F11A67206531FB7D7F0DFF59413145E6973C45001D0087B42"
                    + "D11BC645413AEFF63A42391A39145A591A92200D560195E53B478584FDAE231A"
        )
        testKat(
            dig, "abc", "4E2448A4C6F486BB16B6562C73B4020BF3043E3A731BCE721AE1B303D97E6D4C"
                    + "7181EEBDB6C57E277D0E34957114CBD6C797FC9D95D8B582D225292076D4EEF5"
        )
        testKat(
            dig, "message digest", "378C84A4126E2DC6E56DCC7458377AAC838D00032230F53CE1F5700C0FFB4D3B"
                    + "8421557659EF55C106B4B52AC5A4AAA692ED920052838F3362E86DBD37A8903E"
        )
        testKat(
            dig, "abcdefghijklmnopqrstuvwxyz", "F1D754662636FFE92C82EBB9212A484A8D38631EAD4238F5442EE13B8054E41B"
                    + "08BF2A9251C30B6A0B8AAE86177AB4A6F68F673E7207865D5D9819A3DBA4EB3B"
        )
        testKat(
            dig, "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
                    + "abcdefghijklmnopqrstuvwxyz0123456789", "DC37E008CF9EE69BF11F00ED9ABA26901DD7C28CDEC066CC6AF42E40F82F3A1E"
                    + "08EBA26629129D8FB7CB57211B9281A65517CC879D7B962142C65F5A7AF01467"
        )
        testKat(
            dig, ("123456789012345678901234567890"
        ...
        testKat(
            dig, "abcdbcdecdefdefgefghfghighijhijk", (
    ...
    /**
     * Test Whirlpool0 implementation.
     */
    @Test
    fun testWhirlpool0() {
        ...
        testKat(
            dig0, "The quick brown fox jumps over the lazy dog", (
        ...
        testKat(
            dig0, "The quick brown fox jumps over the lazy eog", (
    ...
    /**
     * Test Whirlpool1 implementation.
     */
    @Test
    fun testWhirlpool1() {
        ...
        testKat(
            dig1, "The quick brown fox jumps over the lazy dog", (
        ...
        testKat(
            dig1, "The quick brown fox jumps over the lazy eog", (
